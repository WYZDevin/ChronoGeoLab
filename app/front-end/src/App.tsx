    ...
    <>
      ...
      <header className="w-full bg-gradient-to-r from-blue-600 to-indigo-800 text-white p-3 shadow-md flex justify-between items-center">
        <div className="flex items-center">
          <h1 className="text-xl font-bold mr-4">ChronoGeoLab</h1>
          <span className="text-sm border-l border-white/30 pl-4">An open toolkit for time-geographic visualization, space-time analysis, and mobility-based exposure research.</span>
        </div>
