...
1. In Docker Desktop, use the **search bar** at the top to find
   **`yongzwu/chronogeolab-backend`** and click **Pull**.
2. Search for **`yongzwu/chronogeolab-frontend`** and **Pull** it too.
3. In the **Images** tab, press **Run** (▶) next to **chronogeolab-backend**.
   Under **Optional settings**, set:
   - **Container name:** `cgl-backend`
   - **Host port:** `8000`
4. Do the same for **chronogeolab-frontend** with:
...
Go to <http://localhost:5173>. You should see the **ChronoGeoLab** home screen.
