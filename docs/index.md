...
hero:
  name: ChronoGeoLab
  text: An open toolkit for time-geographic visualization, space-time analysis, and mobility-based exposure research.
  actions:
    - theme: brand
      text: Get Started
    ...
    - theme: alt
      text: View on GitHub
      link: https://github.com/WYZDevin/ChronoGeoLab
