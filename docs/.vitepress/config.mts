...
// Project site on GitHub Pages → served under /ChronoGeoLab/
const base = '/ChronoGeoLab/'
...
export default defineConfig({
  ...
  head: [
    ...
    ['meta', { property: 'og:title', content: 'ChronoGeoLab' }],
    [
      'meta',
      {
  ...
  themeConfig: {
    nav: [
      ...
      { text: 'About', link: '/about', activeMatch: '/about' },
      {
        ...
        items: [
          {
            text: 'Changelog',
            link: 'https://github.com/WYZDevin/ChronoGeoLab/commits/main',
          },
          {
            text: 'Report an issue',
            link: 'https://github.com/WYZDevin/ChronoGeoLab/issues',
          },
        ],
      },
    ],
    ...
    socialLinks: [
      { icon: 'github', link: 'https://github.com/WYZDevin/ChronoGeoLab' },
    ],
    ...
    editLink: {
      pattern:
        'https://github.com/WYZDevin/ChronoGeoLab/edit/main/docs/:path',
      text: 'Edit this page on GitHub',
    },

    footer: {
      message: 'Released under the MIT License.',
      copyright: 'Copyright © 2026 ChronoGeoLab',
    },
