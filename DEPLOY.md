...
| Image | Source | Serves |
|-------|--------|--------|
| `<namespace>/chronogeolab-backend` | `app/back-end/Dockerfile` | Flask API via **gunicorn** on port `8000` |
| `<namespace>/chronogeolab-frontend` | `app/front-end/Dockerfile` | Static React bundle via **nginx** on port `80` |
